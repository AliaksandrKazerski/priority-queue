...
// Create clone Parent
		if (this.parent !== null && this.parent.right !== null && this.parent.left === this) {
			this.parent.right.parent = tempParent;
			tempParent.right = this.parent.right;
			this.parent.right = null;
		}
		if (this.parent !== null && this.parent.left !== null && this.parent.right === this) {
			this.parent.left.parent = tempParent;
			tempParent.left = this.parent.left;
			this.parent.left = null;
		}
		if (this.parent !== null && this.parent.parent !== null && this.parent.parent.left === this.parent) {
			this.parent.parent.left = tempParent;
			tempParent.parent = this.parent.parent;
			this.parent.parent = null;
		}
		if (this.parent !== null && this.parent.parent !== null && this.parent.parent.right === this.parent) {
...
// Get information from clone This
		...
		if (this.parent !== null && this.parent.left !== null && this.parent.left === tempParent) {
			this.parent.left = this;
			tempParent.parent = null;
		}
		if (this.parent !== null && this.parent.right !== null && this.parent.right === tempParent) {
